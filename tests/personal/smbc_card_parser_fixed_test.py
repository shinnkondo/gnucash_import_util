...
from gnucash_csv_importer.personal.smbc_card_parser_fixed import SmbcCardParser
...
class TestSmbcCardParser:
    ...
    def test_is_applicable(self):
        line = "山本　太郎　様,1111-1111-1111-1***,Ａｍａｚｏｎマスタークラシック"
    ...
    def test_extract_fields(self):
        row = ['2018/8/8','Company', '740', '1', '1', "740"]
